...
export default function GoalSection({
  ...
  newGoalCategory, setNewGoalCategory, addGoal, addTask, cycleStatus, onMarkTaskDone, onGoalMenu, onTaskMenu,
  templatesForTimeframe, onUseTemplate,
}) {
    ...
    <div>
      <div className="flex items-baseline justify-between mb-3 gap-2">
        ...
        <div className="flex items-center gap-2 shrink-0">
          {templatesForTimeframe && templatesForTimeframe.length > 0 && (
            <button
              onClick={() => onUseTemplate(timeframe)}
              className="wm-btn-ghost text-xs px-2.5 py-1.5 rounded-sm flex items-center gap-1"
      ...
      <div className="space-y-3">
        ...
        {list.map((g) => (
          <GoalCard
            ...
            onMarkTaskDone={(tid) => onMarkTaskDone(g.id, tid)}
