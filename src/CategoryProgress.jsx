...
export default function CategoryProgress({ categories, goals, onSelect }) {
  ...
  const stats = rows.map((row) => {
    ...
    return { ...row, goalCount: goalsInRow.length, done, doing, todo, total, overdue, attention };
  });
        ...
        {stats.map((s) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-sm w-28 shrink-0 truncate">{s.name}</span>
